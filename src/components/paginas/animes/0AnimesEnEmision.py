...
async def main():
    global anime_processed
    while True:  # Agregar el bucle while aquí
        for base_url in anime_links:
            async with aiohttp.ClientSession() as session:
                ...
                # Obtener el último episodio en el archivo JSON existente
                ...
                anime_processed += 1
                anime_processed = 0  # Reiniciar el contador de anime procesado al final del bucle
